  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ route('blog.admin.posts.index') }}"><i class="fa fa-sticky-note-o"></i> <span>Пости</span></a></li>
        <li><a href="{{ route('blog.admin.categories.index') }}"><i class="fa fa-list-ul"></i> <span>Категорії</span></a></li>
        <li><a href="#"><i class="fa fa-tags"></i> <span>Теги</span></a></li>
        <li>
          <a href="#">
            <i class="fa fa-commenting"></i> <span>Комментарії</span>
